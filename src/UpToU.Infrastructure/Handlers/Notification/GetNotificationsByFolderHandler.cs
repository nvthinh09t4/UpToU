...
public class GetNotificationsByFolderHandler
    : IRequestHandler<GetNotificationsByFolderQuery, Result<PagedResult<NotificationDto>>>
{
    private readonly ApplicationDbContext _db;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public GetNotificationsByFolderHandler(ApplicationDbContext db, IHttpContextAccessor httpContextAccessor)
    {
        _db = db;
    ...
    public async Task<Result<PagedResult<NotificationDto>>> Handle(
        GetNotificationsByFolderQuery request, CancellationToken ct)
    {
        ...
        query = request.Folder switch
        {
            "Archive" => query.Where(n => n.IsArchived && !n.IsImportant),
            "Important" => query.Where(n => n.IsImportant),
            "Unread" => query.Where(n => !n.IsRead && !n.IsArchived),
            _ => query.Where(n => !n.IsArchived), // Inbox: everything not archived
        };
        ...
        var items = await query
            ...
            .Select(n => new NotificationDto(
                n.Id, n.Type, n.StoryId, n.CommentId, n.ActorName,
